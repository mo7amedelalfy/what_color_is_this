package com.nicotroia.whatcoloristhis.view.pages
{
	...
	public class WelcomePageMediator extends PageBaseMediator
	{
		...
		override protected function pageAddedToStageHandler(event:Event=null):void
		{
			...
			//Restore memory used up by CameraUI?
			System.gc();
			
			//reset this here to make sure an old target won't show in results from a favorite
			cameraModel.targetedPixels = null;
			...
			welcomePage.favoritesButton.addEventListener(Event.TRIGGERED, favoritesButtonTriggeredHandler);
		}
		
		private function favoritesButtonTriggeredHandler(event:Event):void
		{
			eventDispatcher.dispatchEvent(new NavigationEvent(NavigationEvent.NAVIGATE_TO_PAGE, SequenceModel.PAGE_Favorites));
		}
		...
		{ 
			...
			welcomePage.favoritesButton.removeEventListener(Event.TRIGGERED, favoritesButtonTriggeredHandler);
