package com.nicotroia.whatcoloristhis.model
{
	...
	public class SequenceModel extends Actor
	{
		...
		public function SequenceModel()
		{
			...
			_overlayList = new <Class>[OVERLAY_NavBar, OVERLAY_BackButton];
			...
			overlayWaitingList[OVERLAY_NavBar] = new <Class>[ PAGE_Welcome, PAGE_About, PAGE_AreaSelect, PAGE_Result ];
			overlayWaitingList[OVERLAY_BackButton] = new <Class>[ PAGE_About, PAGE_AreaSelect, PAGE_Result ];
